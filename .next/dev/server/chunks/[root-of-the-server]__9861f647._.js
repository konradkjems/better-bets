...
async function connectToDatabase() {
    ...
    const uri = ("TURBOPACK compile-time value", "mongodb+srv://konradkjems:LI,k8991qw!@cluster0.rklzlve.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
...
"[project]/src/app/api/calculations/list/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        const userId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])();
        ...
        const calculations = await calculationsCollection.find({
            userId
        }).sort({
            createdAt: -1
        }).skip(skip).limit(limit).toArray();
        const total = await calculationsCollection.countDocuments({
            userId
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9861f647._.js.map